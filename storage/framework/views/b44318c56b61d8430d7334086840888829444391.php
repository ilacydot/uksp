...
<body>
 ...
 <header>
 <div class="awal">
    <img src="<?php echo e(asset('image/smk.png')); ?>" alt="Gambar Kiri" />
  <p class="center-text">
    SMKN 1 Kota Bengkulu<br />UKS (Unit Kesehatan Sekolah)
  </p>
    <img src="<?php echo e(asset('image/uks.png')); ?>" alt="Gambar Kanan" />
</div>
...
<div id="menu-bar" class="fas fa-bars"></div>
    ...
    <div class="login-form-container">
      ...
      <button id="signUpBtn" href="<?php echo e(asset('/public/register.html')); ?>">Sign Up</button>
        <button id="signInBtn" href="<?php echo e(asset('/public/login.html')); ?>" >Sign In</button>
      </div>
    </div>
    ...
    <img src="<?php echo e(asset('image/pmr.png')); ?>" alt="Gambar Kiri" />
      </div>
    </section>
...
</html><?php /**PATH D:\xampp\htdocs\projectuks\resources\views/uks.blade.php ENDPATH**/ ?>